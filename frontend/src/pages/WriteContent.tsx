...
<div className="flex flex-col h-screen gap-4 max-w-xxl mx-auto my-8 p-4 sm:p-6">
  ...
  <label className="sr-only" htmlFor="content">Content</label>
  <textarea
    id="content" // Added id for accessibility
    placeholder='Content'
    onChange={(e) => setContent(e.target.value)}
    className="p-3 border-2 border-gray-200 rounded-md text-lg placeholder-gray-400 focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-300 transition duration-200 h-2/4 w-full resize-none"
  />
